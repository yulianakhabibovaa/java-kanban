...
class ManagersTest {
    ...
    void shouldReturnWorkingDefaultTaskManager() {
        ...
        SubTask subTask = taskManager.create(new SubTask("подзадача", "я подзадача 1", 0, Duration.ofMinutes(30L), now.plusMinutes(30L)));
        ...
        assertIterableEquals(List.of(subTask), taskManager.getSubTasksByEpic(epic.getId()));
    ...
    void shouldReturnWorkingDefaultHistoryManager() {
        ...
        Epic epic = new Epic("эпик", "я эпик 1", Status.NEW, 0, new ArrayList<>(), Duration.ZERO, null, null);
        SubTask subTask = new SubTask("подзадача", "я подзадача 1", Status.NEW, 1, Duration.ofMinutes(30L), now.plusMinutes(30L), 0);
        Task task = new Task("задача", "я  задача", Status.NEW, 2, Duration.ofMinutes(30L), now.plusMinutes(30L));
